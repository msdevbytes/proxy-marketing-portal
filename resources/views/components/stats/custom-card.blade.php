<div @class(['flex flex-col rounded-md overflow-hidden shadow-md', $class])>
    <div @class(['p-5 text-white bg-gradient-to-t relative ', $bgColor])>
        @isset($icon)
            <span class="absolute right-0">
                @svg($icon, 'w-64 h-64 text-white/10')
            </span>
        @endisset
    ...
    @isset($data)
        <div
            class="flex z-10 bg-gradient-to-tr from-gray-200 to-gray-50 dark:bg-gradient-to-tr dark:from-gray-900 dark:to-gray-600 p-5">
            <div
                ...
                @foreach ($data as $item)
                    <div
                        ...
                        <div class="flex md:flex-row flex-col items-center justify-start line md:gap-3 !leading-none gap-4">
