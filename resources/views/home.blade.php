    ...
    <section class="">
        ...
        <div class="container max-w-screen-xl mx-auto px-4">
            ...
            <div class="flex items-center justify-center h-screen">
                ...
                <img src="/images/logo2.jpg" class="h-64" alt="Image">

                {{-- <h6 class="font-medium text-gray-600 text-lg md:text-2xl uppercase mb-8">HS MARKETING EXPERT</h6> --}}

                {{-- <h1 class="font-normal text-gray-900 text-4xl md:text-7xl leading-none mb-8">Senior Backend Developer
                </h1>
